  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '12px 14px', borderBottom: '1px solid var(--border)' }}>
        ...
        {args && (
          <pre style={{
            margin: '8px 0 0', padding: '6px 10px', background: 'var(--bg-tertiary)',
            borderRadius: 4, fontSize: 10, whiteSpace: 'pre-wrap', wordBreak: 'break-all',
            maxHeight: 160, overflow: 'auto', color: 'var(--text-secondary)',
          }}>
            {args}
          </pre>
        )}
